            ...
            <div className="mb-0">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-400">{todoCompleted}/{todoTotal}</span>
                </div>
                <ChevronLeft
                  size={14}
                  className={`transition-transform ${isTodoExpanded ? 'rotate-0' : '-rotate-90'}`}
                />
              </div>
              ...
              {!isTodoExpanded ? (
                <div className="mt-1 px-2">
                  <div className="flex items-center justify-between gap-2">
                    <div className="text-xs text-gray-700 truncate">
                      {currentTodo ? currentTodo.content : '暂无任务'}
                    </div>
                ...
                <div className="mt-2 px-2">
                  <div className="flex items-center justify-between text-[10px] text-gray-400 mb-2">
                    <span>进度</span>
                    <span>{todoCompleted}/{todoTotal} · {todoProgress}%</span>
                  </div>
                  ...
                  <div className="space-y-1 max-h-40 overflow-auto pr-1">
                    {activeTodos.map((todo, idx) => {
                      ...
                      return (
                        <div
                          key={`${todo.content}_${idx}`}
                          className="flex items-start gap-2 rounded-lg border border-gray-100 bg-white px-2 py-1.5"
                        >
